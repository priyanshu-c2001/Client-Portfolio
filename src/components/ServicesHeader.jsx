        ...
        <div className="w-full bg-gray-300 py-16 md:py-40">
            <div className="mx-auto max-w-7xl px-4 mt-24 md:mt-14">
                <div className="text-center">
                    <h1 className="font-sans text-5xl font-semibold md:text-6xl text-foreground mb-6">Services</h1>
          ...
          */}
            ...
            */}
                        <ol className="flex items-center justify-center gap-2.5">
                            ...
                            <li className="inline-flex items-center">
                                <span className="text-sm font-semibold text-foreground uppercase tracking-wider">SERVICES</span>
                            </li>
                        </ol>
                    </nav>
